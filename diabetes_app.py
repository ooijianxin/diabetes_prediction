...
# Debug: Show available features and selected features
if st.checkbox("Show debug information"):
    st.write("All available features:", list(input_df.columns))
    st.write("Selected features from model:", selected_features)
...
if st.button("Predict Diabetes Risk", type="primary"):
    try:
        ...
        if prediction[0] == 1 or risk_percentage > 50:
        ...
        if st.checkbox("Show technical details"):
            ...
            st.write("Processed input features:", input_df_selected.T)
